...
exports.run = async (client, message) => {
  ...
  const istatistikozel = new Discord.MessageEmbed()
    ...
    .setTitle("SUN BOT İstatistik")
    .addField("• Ekibimiz •", "<@727108703299436614>", true)
    .addField(
      " Bana Botu Yaparken Bir Çok Yardımı Dokunduğu İçin Teşekkürler",
      "<@724972301002473553>",
      true
    )
    .addField(
      "• Sürümler •",
      `Discord.JS: **${Discord.version}**\n Node.JS: **${process.version}**\n Discord.JS-commando: **v0.11.0-dev**`,
      true
    )
    .addField(
      "• Vds Bilgileri •",
    ...
    .addField(
      "• Shard •",
      `${message.guild.shardID + 1}/${client.shard.count}`,
      true
    ) //Bu sunucunun shardı: ${client.shard.id} | Shard sayısı: ${client.shard.count}

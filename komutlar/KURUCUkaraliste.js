...
exports.run = async (client, message, args) => {
  if (message.author.id !== "727108703299436614")
    if (message.author.id !== "724972301002473553s")
  ...
  const westrabumm = new Discord.MessageEmbed()
    ...
    .setTimestamp()
    .setDescription(
      ` <@${message.author.id}> adlı yetkilimiz tarafından karalisteye alındın! Artık Crypto'nun komutlarını kullanamazsın. Karalisteye alınma sebebin: **${sebep}**`
    );
